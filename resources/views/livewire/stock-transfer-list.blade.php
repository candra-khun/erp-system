                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex gap-3 items-start">
                            ...
                            <input type="number" wire:model="items.{{ $index }}.quantity" min="1" step="0.01" placeholder="Qty" class="w-28 border-gray-300 rounded-md shadow-sm text-sm focus:border-blue-500 focus:ring-blue-500">
                            @if(count($items) > 1)
